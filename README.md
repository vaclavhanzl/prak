...
Download prak zip file from this GitHub page - click on the green "Code" button up right, download zip. Uncompress it directly to ```C:\```, creating ```C:\prak```. If the uncompressed file is named something like 'prak-main', rename it to 'prak'.
